...
%%%Initializes a shared multi-layer perceptron (MLP).
weights = initializeWeightsHes([1 1 inputChannelSize hiddenChannelSize(1)]);
...
for k = 2:numel(hiddenChannelSize)
    weights = initializeWeightsHes([1 1 hiddenChannelSize(k-1) hiddenChannelSize(k)]);
